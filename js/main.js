  ...
  function liquidFillGaugeDefaultSettings() {
    return {
      ...
      displayDegrees: false, // if true, show degree symbol
  ...
  function loadLiquidFillGauge(elementId, value, config) {
    ...
    var tempText         = config.displayDegrees ? "°" : "";
    ...
    var text1 = gaugeGroup.append("text")
      ...
      .text(textRounder(textStartValue) + tempText)
    ...
    var clipArea = d3.svg.area()
      ...
      if (config.valueCountUp) {
        var textTween = function() {
          ...
          return function(t) {
            ...
            this.textContent = textRounder(i(t)) + tempText;
          }
        };
        text1.transition()
      ...
      function GaugeUpdater() {
        ...
        var textTween = function() {
          ...
          return function(t) { this.textContent = textRounderUpdater(i(t)) + tempText; }
        };
